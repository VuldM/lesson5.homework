...
public class BookingPresenter implements ViewObserver {
    ...
    public void onChangeReservationTable(int oldReservation, Date reservationDate, int tableNo, String name) {
       int result =  model.changeReservationTable(oldReservation,reservationDate, tableNo, name);
        updateChangeReservationResultUI(result);
    }
    public void updateChangeReservationResultUI(int result){
        view.showChangeReservationResult(result);
    }
}
